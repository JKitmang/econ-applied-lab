    ...
    methodologies: {
      ...
      rct: {
        ...
        exhibits: [
          ...
          { id: "itt", n: "Table 2", title: "Main results (ITT)", type: "table", render: "rctmain",
            story: "Build the spec: unadjusted diff → + baseline covariates (ANCOVA, the efficiency win) → + strata FE (the design controls). Report the control mean. LATE is shown when there is non-compliance.",
            ejd: [{ label: "EJD: intention to treat", url: ejd("intention-to-treat") }] },
          { id: "attrition", n: "Table 3", title: "Attrition analysis", type: "table", render: "rctattrition",
            story: "Differential attrition is the silent killer of an RCT. Show attrition by arm and test the difference; if it is non-zero, bound the effect (Lee bounds) rather than ignore it.",
            ejd: [{ label: "EJD: attrition", url: ejd("attrition bounds") }] },
          { id: "rctHet", n: "Figure 1", title: "Heterogeneity (forest plot)", type: "figure", render: "rctheterogeneity",
            story: "Pre-specified subgroups only — a forest plot keeps you honest about how many cuts you took. One row per subgroup, point + CI, zero line.",
            ejd: [{ label: "EJD: heterogeneous effects", url: ejd("heterogeneous treatment effects") }] },
        ],
      },
      ...
      iv: {
        ...
        exhibits: [
          ...
          { id: "ivmain", n: "Table 2", title: "OLS vs 2SLS", type: "table", render: "ivresults",
            story: "The money table: OLS (biased) next to 2SLS, with the first-stage F in the panel. The gap between them is the story; the F tells the reader whether to believe the 2SLS column.",
            ejd: [{ label: "EJD: 2SLS", url: ejd("two-stage least squares") }, { label: "EJD: weak instruments", url: ejd("weak instruments") }] },
        ],
      },
      ...
      rdd: {
        ...
        exhibits: [
          ...
          { id: "rdmain", n: "Table 2", title: "Estimates & robustness", type: "table", render: "rddestimates",
            story: "The RD estimate must survive bandwidth and polynomial choices — show a grid, not a single number. The density test and a covariate placebo (jump ≈ 0) defend against manipulation.",
            ejd: [{ label: "EJD: rdrobust / CCT", url: ejd("rdrobust bias-corrected") }, { label: "EJD: density test", url: ejd("manipulation density") }] },
        ],
      },
    },
  };
